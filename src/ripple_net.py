...
# DISCLAIMER
# This code file is forked and adapted from https://github.com/tezignlab/RippleNet-TF2/blob/master/model/ripple_net.py, which is under an MIT license.
...
# import custom code
from src.ripplenet_layers import Squeeze, ExpandDims, Embedding2D
from src.ripplenet_model import BuildModel
from src.metrics import auc, f1, precision, recall
...
class RippleNet(BuildModel):
    ...
    def build_model(self):
        ...
        model.compile(optimizer=Adam(self.lr), metrics=[binary_accuracy, auc, precision, recall, f1])
        return model
